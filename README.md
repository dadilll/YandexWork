...
- [ ] Задача : Сделать для разных выражений разное время выполнения
...
## Перед запуском
Перед запуском необходимо установить Redis, также требуется настроить количество агентов и воркеров в agentmain(в файле main.go).
